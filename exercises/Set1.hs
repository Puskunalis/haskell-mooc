...
pointDistance x y = square (abs (x - y))

distance :: Double -> Double -> Double -> Double -> Double
distance x1 y1 x2 y2 = sqrt (pointDistance x1 x2 + pointDistance y1 y2)
...
checkPassword "swordfish" = loginMessage
checkPassword "mellon" = loginMessage
checkPassword _ = errorMessage
...
ilog3' 0 divs = divs
ilog3' n divs = ilog3' (n `div` 3) (divs + 1)
